...
export default function MovieForm(props: movieFormProps) {
   ...
   const[selectedActors, setSelectedActors]=useState(props.selectedActors)
    const [selectedMovieTheaters, setSelectedMovieTheaters] = useState(mapToModel(props.selectMovieTheaters))
    const [nonSelectedMovieTheaters, setNonSelectedMovieTheaters] = useState(mapToModel(props.nonSelectMovieTheaters))
...
interface movieFormProps {
    ...
    selectMovieTheaters: movieTheaterDTO[];
    nonSelectMovieTheaters: movieTheaterDTO[];
